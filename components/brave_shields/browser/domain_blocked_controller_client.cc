...
void DomainBlockedControllerClient::SetReportingPreference(bool report) {
  // This has nothing to do with reporting. We reuse this method for tracking
  // the state of the "Don't warn about this site again" checkbox.
  dont_warn_again_ = report;
}
