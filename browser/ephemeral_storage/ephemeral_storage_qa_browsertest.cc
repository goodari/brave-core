...
class EphemeralStorageTest : public InProcessBrowserTest {
 public:
  ...
  void CheckStorageResults(content::WebContents* contents, StorageType storage_type, const StorageResult expected[4]) {
    ASSERT_EQ(true, EvalJs(contents, "document.querySelector('#storage-rs .row-" + AsString(storage_type) + " .cell-this-frame.bg-" + AsString(expected[0]) + "') !== null"));
    ASSERT_EQ(true, EvalJs(contents, "document.querySelector('#storage-rs .row-" + AsString(storage_type) + " .cell-local-frame.bg-" + AsString(expected[1]) + "') !== null"));
    ASSERT_EQ(true, EvalJs(contents, "document.querySelector('#storage-rs .row-" + AsString(storage_type) + " .cell-remote-frame.bg-" + AsString(expected[2]) + "') !== null"));
    ASSERT_EQ(true, EvalJs(contents, "document.querySelector('#storage-rs .row-" + AsString(storage_type) + " .cell-nested-frame.bg-" + AsString(expected[3]) + "') !== null"));
  }
